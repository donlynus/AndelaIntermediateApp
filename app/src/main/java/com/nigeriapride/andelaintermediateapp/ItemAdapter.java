package com.nigeriapride.andelaintermediateapp;
...
import com.nigeriapride.andelaintermediateapp.controller.DetailActivity;
               ...
               @Override
                public void onClick(View v){
                   ...
                   if(pos != RecyclerView.NO_POSITION){
                       ...
                       Toast.makeText(v.getContext(), "You Click" + clickedDataItem.getLogin(),Toast.LENGTH_SHORT).show();
                   }
               }
            });
